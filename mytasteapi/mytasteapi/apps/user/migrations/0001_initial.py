    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('gender', models.IntegerField(choices=[(1, '男'), (2, '女'), (3, '保密')], null=True, verbose_name='性别')),
                ('avatar', models.ImageField(null=True, upload_to=user.models.User.user_directory_path, verbose_name='用户头像')),
                ('county', models.CharField(blank=True, max_length=100, verbose_name='国家')),
                ('province', models.CharField(blank=True, max_length=100, verbose_name='地区')),
